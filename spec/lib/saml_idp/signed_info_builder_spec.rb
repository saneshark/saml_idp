...
module SamlIdp
  describe SignedInfoBuilder do
    ...
    it "builds a legit digest of the XML file (multi_cert = false)" do
      allow(SamlIdp.config).to receive(:idp_multi_cert).and_return(nil)
